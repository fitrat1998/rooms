...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'tanlangani ko`chirish',
      moveAllLabel: 'hammasini ko`chirish',
      removeSelectedLabel: 'tanlangani o`chirish',
      ...
      infoText: 'Barchasini ko`rsatish {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="badge badge-warning">filterlangan</span> {0} dan {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'ro`yhat bosh',                                                        // when there are no options present in the list
